...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:625-629](../shor.html#L625-L629)）
...
（[shor.html:876-877](../shor.html#L876-L877)）に、`confirmDrift()`
（[shor.html:634-639](../shor.html#L634-L639)）から呼ばれる。
...
だけの扱いとする（[shor.html:631-633](../shor.html#L631-L633)のコメント参照）。
...
（[shor.html:857](../shor.html#L857), [shor.html:910](../shor.html#L910)）
...
- ただし「`peek_drift`が候補を返した直後、クライアントに画像URLが渡って
  ...
  （[shor.html:796-803](../shor.html#L796-L803)）が画像を先読みし、
