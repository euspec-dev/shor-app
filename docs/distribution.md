...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:658-662](../shor.html#L658-L662)）
...
（[shor.html:958-959](../shor.html#L958-L959)）に、`confirmDrift()`
（[shor.html:667-672](../shor.html#L667-L672)）から呼ばれる。
...
だけの扱いとする（[shor.html:664-666](../shor.html#L664-L666)のコメント参照）。
...
（[shor.html:939](../shor.html#L939), [shor.html:992](../shor.html#L992)）
...
- ただし「`peek_drift`が候補を返した直後、クライアントに画像URLが渡って
  ...
  （[shor.html:878-885](../shor.html#L878-L885)）が画像を先読みし、
