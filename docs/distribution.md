...
SQL側の実体は次の5つのマイグレーションファイル。上から順に実行されている。
...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:806-810](../shor.html#L806-L810)）
...
（[shor.html:1106-1107](../shor.html#L1106-L1107)）に、`confirmDrift()`
（[shor.html:815-820](../shor.html#L815-L820)）から呼ばれる。
...
だけの扱いとする（[shor.html:812-814](../shor.html#L812-L814)のコメント参照）。
...
（[shor.html:1087](../shor.html#L1087), [shor.html:1140](../shor.html#L1140)）
...
- ただし「`peek_drift`が候補を返した直後、クライアントに画像URLが渡って
  ...
  （[shor.html:1026-1033](../shor.html#L1026-L1033)）が画像を先読みし、
