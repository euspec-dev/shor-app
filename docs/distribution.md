...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:628-632](../shor.html#L628-L632)）
...
（[shor.html:879-880](../shor.html#L879-L880)）に、`confirmDrift()`
（[shor.html:637-642](../shor.html#L637-L642)）から呼ばれる。
...
だけの扱いとする（[shor.html:634-636](../shor.html#L634-L636)のコメント参照）。
...
（[shor.html:860](../shor.html#L860), [shor.html:913](../shor.html#L913)）
...
- ただし「`peek_drift`が候補を返した直後、クライアントに画像URLが渡って
  ...
  （[shor.html:799-806](../shor.html#L799-L806)）が画像を先読みし、
