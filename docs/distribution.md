...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:979-983](../shor.html#L979-L983)）
...
（[shor.html:988-993](../shor.html#L988-L993)）から呼ばれる。
...
だけの扱いとする（[shor.html:985-987](../shor.html#L985-L987)のコメント参照）。
