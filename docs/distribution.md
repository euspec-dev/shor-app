...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:470-474](../shor.html#L470-L474)）
...
（[shor.html:707-708](../shor.html#L707-L708)）に、`confirmDrift()`
（[shor.html:479-484](../shor.html#L479-L484)）から呼ばれる。
...
だけの扱いとする（[shor.html:476-478](../shor.html#L476-L478)のコメント参照）。
...
（[shor.html:686](../shor.html#L686), [shor.html:739](../shor.html#L739)）
