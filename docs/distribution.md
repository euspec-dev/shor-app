...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:655-659](../shor.html#L655-L659)）
...
（[shor.html:907-908](../shor.html#L907-L908)）に、`confirmDrift()`
（[shor.html:664-669](../shor.html#L664-L669)）から呼ばれる。
...
だけの扱いとする（[shor.html:661-663](../shor.html#L661-L663)のコメント参照）。
...
（[shor.html:888](../shor.html#L888), [shor.html:941](../shor.html#L941)）
...
- ただし「`peek_drift`が候補を返した直後、クライアントに画像URLが渡って
  ...
  （[shor.html:827-834](../shor.html#L827-L834)）が画像を先読みし、
