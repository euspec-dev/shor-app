...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:486-490](../shor.html#L486-L490)）
...
（[shor.html:732-733](../shor.html#L732-L733)）に、`confirmDrift()`
（[shor.html:495-500](../shor.html#L495-L500)）から呼ばれる。
...
だけの扱いとする（[shor.html:492-494](../shor.html#L492-L494)のコメント参照）。
...
（[shor.html:713](../shor.html#L713), [shor.html:766](../shor.html#L766)）
...
- ただし「`peek_drift`が候補を返した直後、クライアントに画像URLが渡って
  ...
  （[shor.html:657-664](../shor.html#L657-L664)）が画像を先読みし、
...
実データの投入は運用側の作業として残っている
（`supabase_migration.sql`末尾に投入例のコメントあり）。
