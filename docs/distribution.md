...
写真を開いた瞬間、`getRandomDrift()`（[shor.html:488-492](../shor.html#L488-L492)）
...
（[shor.html:734-735](../shor.html#L734-L735)）に、`confirmDrift()`
（[shor.html:497-502](../shor.html#L497-L502)）から呼ばれる。
...
だけの扱いとする（[shor.html:494-496](../shor.html#L494-L496)のコメント参照）。
...
（[shor.html:715](../shor.html#L715), [shor.html:768](../shor.html#L768)）
...
- ただし「`peek_drift`が候補を返した直後、クライアントに画像URLが渡って
  ...
  （[shor.html:659-666](../shor.html#L659-L666)）が画像を先読みし、
