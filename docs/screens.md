...
（[shor.html:584](../shor.html#L584)）が`.active`クラスを付け替えることで
...
- 表示関数: `renderHome()`（[shor.html:621](../shor.html#L621)）
...
- 表示関数: `openView(origin)`（[shor.html:668](../shor.html#L668)）。
...
- 表示関数: `openDone()`（[shor.html:965](../shor.html#L965)、投稿直後）
  / `backToDone()`（[shor.html:966](../shor.html#L966)、閲覧起点がdoneで
...
（`showModal()`/`hideModal()`, [shor.html:1017-1023](../shor.html#L1017-L1023)）。
