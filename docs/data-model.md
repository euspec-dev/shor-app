...
（[shor.html:630-631](../shor.html#L630-L631)）。
...
（[shor.html:687](../shor.html#L687)）。`posts.image_url`にはパスではなく
...
- `isPng(buffer)`（[shor.html:1132-1138](../shor.html#L1132-L1138)）
  PNGのシグネチャ（先頭8バイト）を見るだけの単純な判定。EXIF解析はしない。
- `handlePickedFile(file, fromCamera)`（[shor.html:1047-1063](../shor.html#L1047-L1063)）
...
- **iOS**: `btn-pick`「＋ 写真を選ぶ」を押すと自前モーダルを挟まず
  `file-input`を直接開く（[shor.html:1014-1028](../shor.html#L1014-L1028)、
