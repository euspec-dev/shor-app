...
実装。コードは[shor.html:711-802](../shor.html#L711-L802)にまとまっている。
...
`resetDevelop(hard)`（[shor.html:717-726](../shor.html#L717-L726)）が
...
`DEVELOP_MS = 5000`（[shor.html:446](../shor.html#L446)）で正規化した
進捗`t`（0〜1）から、`e = 1 - (1-t)^2`という減速イージングを作り、
写真のぼかしと粒度を滑らかに解いていく（[shor.html:728-743](../shor.html#L728-L743)）。
...
`zone.setPointerCapture(e.pointerId)`（[shor.html:748](../shor.html#L748)）
...
2. `confirmPromise`の完了を待ってから`recordViewHistoryDB()`で
   ...
   （[shor.html:768-772](../shor.html#L768-L772)。UIのwash演出はこれを
...
（[shor.html:569-570](../shor.html#L569-L570)、`contextmenu`/`selectstart`/
