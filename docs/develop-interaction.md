...
実装。コードは[shor.html:1305-1393](../shor.html#L1305-L1393)にまとまっている。
...
`resetDevelop(hard)`（[shor.html:1310-1319](../shor.html#L1310-L1319)）が
...
`DEVELOP_MS = 5000`（[shor.html:896](../shor.html#L896)）で正規化した
進捗`t`（0〜1）から、`e = 1 - (1-t)^2`という減速イージングを作り、
写真のぼかしと粒度を滑らかに解いていく（[shor.html:1321-1336](../shor.html#L1321-L1336)）。
...
案内文（`#under-note`）は`min-height:3.9em`（[shor.html:522](../shor.html#L522)）を
...
`zone.setPointerCapture(e.pointerId)`（[shor.html:1341](../shor.html#L1341)）
...
2. `confirmPromise`の完了を待ってから`recordViewHistoryDB()`で
   ...
   （[shor.html:1361-1365](../shor.html#L1361-L1365)。UIのwash演出はこれを
...
（[shor.html:1089-1090](../shor.html#L1089-L1090)、`contextmenu`/`selectstart`/
